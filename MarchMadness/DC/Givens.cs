...
namespace MarchMadness.DC {
	public static class Givens {
		public static void rot01_post(DMat3 m, double c, double s) {
		...
		public static void rot02_post(DMat3 m, double c, double s) {
		...
		public static void rot12_post(DMat3 m, double c, double s) {
